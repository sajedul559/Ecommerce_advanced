...
@section('content')
<link rel="stylesheet" href="{{asset('public/frontend/product/style.css')}}">
<link rel="stylesheet" href="{{asset('public/frontend/product/product_responsive.css')}}">
					...
					<div><br>
								...
								@endif
										...
										<div class="order_info d-flex flex-row">
											<form action="3" method="post" id="add_to_cart">
												@csrf
